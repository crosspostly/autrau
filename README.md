...
- 🌐 **Автоперевод на английский** — после каждой расшифровки автоматически создаётся `<имя>.en.txt` через LibreTranslate (по умолчанию) или локальный Argos Translate (~280 МБ модель, без облака)
