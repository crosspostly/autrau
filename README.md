...
Переводит речь из аудио- и видеофайлов (`mp3`, `wav`, `m4a`, `ogg`, `flac`, `webm`, `mp4`, `mkv`, `mov`) в текст локально — у видео звук извлекается автоматически (нужен ffmpeg). Четыре бэкенда на выбор — 23 модели суммарно:
